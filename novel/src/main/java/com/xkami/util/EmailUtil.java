...
public class EmailUtil {
	 ...
	 * @throws Exception
	 */
	public static void  sendMessage(String receiveMailAccount,String content) throws Exception {
		// 1. 创建参数配置, 用于连接邮件服务器的参数配置
        Properties props = new Properties();                    // 参数配置
        props.setProperty("mail.transport.protocol", "smtp");   // 使用的协议（JavaMail规范要求）
        props.setProperty("mail.smtp.host", stmp);   // 发件人的邮箱的 SMTP 服务器地址
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, from, receiveMailAccount,content);
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "欢迎加入xkami!", "UTF-8"));
    ...
    /*public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("F:/picture/FairyTail.jpeg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("F:/picture/妖精的尾巴目录.doc"));  // 读取本地文件
